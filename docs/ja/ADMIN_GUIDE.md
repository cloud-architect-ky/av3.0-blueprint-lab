...
| ml.g7e.2xlarge | L-7A3E0A2C | **0** | ≥0 | M2–M6 の**最も安価なネイティブ解像度パス**（RTX PRO 6000 1 枚、96 GB; **デフォルトは 0 — 申請が必要**） |
| ml.g7e.24xlarge | L-E481E4F8 | **0** | ≥0 | M4/M5/M6 代替（RTX PRO 6000 4 枚; **デフォルトは 0**） |
...
> 前にユーザー 1 名で M4 をスモークテストしてください。他の g7e サイズ
