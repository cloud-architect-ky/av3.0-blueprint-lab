...
echo ""
echo "Note there is NO script in this repo that BUILDS hf-cache/hub/ from scratch — see"
echo "docs/en/ADMIN_GUIDE.md. cache_models.sh writes model-cache/ only, in a different"
echo "(flat) layout, and cannot produce this tree. Copying from a seeded region is the"
echo "supported path."
exit 1
